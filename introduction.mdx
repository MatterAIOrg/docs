...
description: "MatterAI is AI Super Intelligence for Humanitym revolutionizing AI Inferencing, AI Code Generation and AI Code Reviews with with Axon Models"
---
...
<Frame>
  <img
    className="block"
    src="https://res.cloudinary.com/dxvbskvxm/image/upload/v1765103135/axon-code-vs-code_kid4yy.webp"
    alt="Axon Code VS Code Extension"
  />
</Frame>
...
Cortex is an AI Code Review platform for your PRs on Github, GitLab, and Bitbucket. Maximize code quality and velocity with the world's most advanced AI code review agent.
